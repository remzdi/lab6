...
void runArrayOperations(LinkedListAssociativeArray<string, double>& array) {
    int choice;
    ...
    do {
        ...
        switch (choice) {
            ...
            case 5: {
                cout << "Array elements: ";
                bool isFirstElement = true;
                for (typename LinkedListAssociativeArray<string, double>::Iterator it = array.begin(); it != array.end(); ++it) {
                    if (!isFirstElement) {
                        cout << ", ";
                    }
                    cout << *it;
...
void runArrayOperations(LinkedListAssociativeArray<string, string>& array) {
    int choice;
    ...
    do {
        ...
        switch (choice) {
            ...
            case 5: {
                cout << "Array elements: ";
                bool isFirstElement = true;
                for (LinkedListAssociativeArray<string, string>::Iterator it = array.begin(); it != array.end(); ++it) {
                    if (!isFirstElement) {
                        cout << ", ";
                    }
                    cout << *it;
